...
require_once dirname(__FILE__) . '/../_class/MultiSiteUserPrivilegesLibraryImpl.php';
 ...
 * Time: 20:24
 */
class MultiSiteUserPrivilegesLibraryImplTest extends PHPUnit_Framework_TestCase
{
    /** @var $privilegesLibrary MultiSiteUserPrivilegesLibraryImpl */
    ...
    public function setUp(){
        ...
        $this->privilegesLibrary = new MultiSiteUserPrivilegesLibraryImpl($db,$siteLibrary);
    ...
    public function testGetPrivilegeWillReturnPrivilege(){
        ...
        $this->assertInstanceOf('MultiSiteUserPrivileges',$ret);
    }
