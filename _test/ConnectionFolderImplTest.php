...
class ConnectionFolderImplTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->testFolder = new FolderImpl(dirname(__FILE__) . '/_stub/ConnectionTestFolder');
        $this->testFolder->create();
        $this->testFolder2 = new FolderImpl(dirname(__FILE__) . '/_stub/ConnectionTestFolder2');
        $this->testFolder2->create();
        $this->testFile = new FileImpl(dirname(__FILE__) . '/_stub/ConnectionTestFile');
        ...
        $this->folder = new ConnectionFolderImpl(dirname(__FILE__) . '/_stub/ConnectionTestFolder', $this->connection);
    ...
    {
        $f = new FileImpl(dirname(__FILE__).'/_stub/fileStub');
