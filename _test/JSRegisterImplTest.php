<?php
require_once dirname(__FILE__) . '/../_class/JSRegisterImpl.php';
...
class JSRegisterImplTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $jsRegister = new JSRegisterImpl();
        $jsFile = new JSFileImpl(dirname(__FILE__) . '/_stub/jsStub.js');
    ...
    public function testRegisteredJSDuplicatesWillNotOccur()
    {
        $jsRegister = new JSRegisterImpl();
        $jsFile = new JSFileImpl(dirname(__FILE__) . '/_stub/jsStub.js');
        $jsFile2 = new JSFileImpl(dirname(__FILE__) . '/_stub/jsStub.js');
