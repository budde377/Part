<?php
require_once dirname(__FILE__).'/../_class/DartRegisterImpl.php';
require_once dirname(__FILE__).'/../_class/DartFileImpl.php';
...
class DartRegisterImplTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $dartFile = new DartFileImpl(dirname(__FILE__) . '/_stub/dartStub.dart');
    ...
    {
        $dartFile = new DartFileImpl(dirname(__FILE__) . '/_stub/dartStub.dart');
        $dartFile2 = new DartFileImpl(dirname(__FILE__) . '/_stub/dartStub.dart');
