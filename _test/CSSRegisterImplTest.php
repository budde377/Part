<?php
require_once dirname(__FILE__) . '/../_class/CSSRegisterImpl.php';
...
class CSSRegisterImplTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $cssRegister = new CSSRegisterImpl();
        $cssFile = new CSSFileImpl(dirname(__FILE__) . '/_stub/cssStub.css');
    ...
    public function testRegisteredCSSDuplicatesWillNotOccur()
    {
        $cssRegister = new CSSRegisterImpl();
        $cssFile = new CSSFileImpl(dirname(__FILE__) . '/_stub/cssStub.css');
        $cssFile2 = new CSSFileImpl(dirname(__FILE__) . '/_stub/cssStub.css');
