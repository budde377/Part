...
require_once dirname(__FILE__).'/../_class/SiteVariablesImpl.php';
/**
...
class SiteVariablesImplTest extends PHPUnit_Extensions_Database_TestCase{
    ...
    {
        return $this->createMySQLXMLDataSet(dirname(__FILE__) . '/_mysqlXML/SiteVariablesImplTest.xml');
    }
