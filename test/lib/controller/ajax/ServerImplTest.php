...
use ChristianBudde\Part\controller\ajax\type_handler\StubTypeHandlerImpl;
...
use ChristianBudde\Part\view\page_element\NullPageElementImpl;
 ...
 * Time: 3:45 PM
 */
class ServerImplTest extends PHPUnit_Framework_TestCase
{
    /** @var  ServerImpl */
    private $server;
    /** @var  StubConfigImpl */
    ...
    protected function setUp()
    {
        ...
        $this->handler1 = new StubTypeHandlerImpl();
        $this->handler2 = new StubTypeHandlerImpl();
    ...
    public function testRegisterFromConfigWillRegister()
    {
        $this->config->setAJAXTypeHandlers([
            ['class_name' => 'ChristianBudde\Part\controller\ajax\type_handler\StubTypeHandlerImpl'],
            ['class_name' => 'ChristianBudde\Part\controller\ajax\type_handler\StubTypeHandlerImpl', 'path' => dirname(__FILE__) . '/type_handler/StubTypeHandlerImpl.php']
        ]);
    ...
    {
        $this->config->setAJAXTypeHandlers([
            ['class_name' => 'ChristianBudde\Part\controller\ajax\StubTypeHandlerGeneratorImpl'],
            ['class_name' => 'ChristianBudde\Part\controller\ajax\StubTypeHandlerGeneratorImpl', 'path' => dirname(__FILE__) . '/StubTypeHandlerGeneratorImpl.php']
        ]);
        StubTypeHandlerGeneratorImpl::setHandler(new StubTypeHandlerImpl(1,2,3));
        $this->server->registerHandlersFromConfig();
    ...
    {
        $this->config->setAJAXTypeHandlers([
            ['class_name' => 'ChristianBudde\Part\controller\ajax\type_handler\StubTypeHandlerImpl', 'path' => $fn = '_stub/notarealink.php']
        ]);
    ...
    {
        $this->config->setAJAXTypeHandlers([
            ['class_name' => 'NotARealClassName', 'path' => dirname(__FILE__) . '/type_handler/StubTypeHandlerImpl.php']
        ]);
    ...
    {
        $this->config->setAJAXTypeHandlers([
            ['class_name' => 'ChristianBudde\Part\util\task\StubTaskImpl']
        ]);
    ...
    private function checkIfFunctionIsCalled($functionName, StubTypeHandlerImpl $handler)
    {
    ...
    public function testHandlerTypeFunctionRight()
    {
        ...
        $type3 = 'SomeElement';
        $handler3 = new StubTypeHandlerImpl();
