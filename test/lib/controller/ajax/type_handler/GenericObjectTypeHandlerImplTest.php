...
use ChristianBudde\Part\controller\ajax\NullServerImpl;
...
class GenericObjectTypeHandlerImplTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->nullAJAXServer = new NullServerImpl();
    ...
    {
        $handler = new GenericObjectTypeHandlerImpl($h = new StubTypeHandlerImpl());
        $handler->setUp(new NullServerImpl(), 'AJAXTypeHandler');
        /** @var JSONFunction $f */
    ...
    public function testStringToConstructorDoesNotAddDefaultInstance()
    {
        ...
        $handler->setUp(new NullServerImpl(), 'User');
        /** @var JSONFunction $f */
    ...
    public function testAddGetInstanceFunctionAddsFunction()
    {
        ...
        $this->handler->setUp(new NullServerImpl(), "Element");
        $list = $this->handler->listFunctions("Element");
