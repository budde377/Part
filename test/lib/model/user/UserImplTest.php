...
use ChristianBudde\Part\util\StubObserverImpl;
use ChristianBudde\Part\util\TruncateOperation;
...
class UserImplTest extends CustomDatabaseTestCase
{
    ...
    {
        parent::__construct($GLOBALS['MYSQL_XML_DIR'] .  '/UserImplTest.xml');
    }
    ...
    {
        return $this->createMySQLXMLDataSet($GLOBALS['MYSQL_XML_DIR'] .  '/UserImplTest.xml');
    }
